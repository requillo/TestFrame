...
<div class="panel-body">
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<?php $form->input('name',array('label' => __('Visa Name','clients'), 'value' => $Visa['name']))?>
		</div>
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<?php $form->input('start_date',array('label' => __('Date of issue','clients'), 'class' => 'date-picker1 form-control', 'value' => $Visa['start_date']))?>
		</div>
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<?php $form->input('end_date',array('label' => __('Date of expiry','clients'), 'class' => 'date-picker2 form-control', 'value' => $Visa['end_date']))?>
		</div>
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
