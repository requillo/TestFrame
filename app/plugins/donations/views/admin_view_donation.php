...
<div class="container-fluid"> 
	<div class="panel panel-default">
		...
		<?php if(!isset($Donation['foundation-info'])): ?>
			...
			<div><i class="fa fa-id-card" aria-hidden="true"></i> <a href="<?php echo get_protected_media($Donation['person-info']['scanned_doc']);?>" target="_blank"><?php echo $Donation['person-info']['id_number'];?></a></div>
		...
		<div class="panel-body">
			...
			<div class="row">
					...
					<div class="alert alert-warning">
						<div class="row">
							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								...
								?>
								<div class="<?php echo $ccl;?>"><strong><cite><?php echo __('Requested'); ?></cite>: SRD <?php echo $donation_info_check['amount']; ?></strong></div>
				...
				<?php if($Donation['document'] != '') { ?>
					<p><a href="<?php echo get_protected_media($Donation['document']); ?>" target="_blank">
				...
				<div class="col-lg-10 col-md-9 col-sm-9 col-xs-12">
					<p class="title"><?php if(!empty($Donation['reason'])) {echo __('Reason','donations');} ?></p>
					<p><?php echo $Donation['reason']; ?></p>						
				</div>
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<p class="title"><?php echo __('Created on','donations'); ?></p>
					<p><?php echo date("d M Y, H:i",strtotime($Donation['created'])); ?> <span class="inl"><?php echo __('by','donations')?> <?php echo $Donation['donated_created_user']['fname'].' '.$Donation['donated_created_user']['lname']?></span></p>						
				</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="table-responsive">
						<table class="table table-bordered bulk_action add-res-data">
							...
							<tbody>
					<?php 
					if(isset($Donation['description-data'][0][0]['amount']) && $Donation['description-data'][0][0]['amount'] != '') {
...
<?php if($Donation['approval'] == 2 && $this->user['role_level'] >= 6 && $Donation['recurring'] == 0){ ?>

<div class="container-fluid">
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center">
			<a class="btn btn-success btn-lg" href="<?php echo admin_url('donations/approve-donation/'.$id.''); ?>"><?php echo __('Approve', 'donations'); ?></a>
		</div>
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center">
			<a class="btn btn-danger btn-lg" href="<?php echo admin_url('donations/disapprove-donation/'.$id.''); ?>"><?php echo __('Disapprove', 'donations'); ?></a>
		</div>
	</div>
</div>
<h1>&nbsp;</h1>
...
<?php if($Donation['approval'] == 2 && $this->user['role_level'] >= 6 && $Donation['recurring'] == 1){ ?>

<div class="container-fluid">
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center">
			<a class="btn btn-success btn-lg" href="<?php echo admin_url('donations/approve-recurring-donation/'.$Donation['recurring_id'].'/'); ?>"><?php echo __('Approve', 'donations'); ?></a>
		</div>
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center">
			<a class="btn btn-danger btn-lg" href="<?php echo admin_url('donations/disapprove-recurring-donation/'.$Donation['recurring_id'].'/'); ?>"><?php echo __('Disapprove', 'donations'); ?></a>
		</div>
	</div>
</div>
<h1>&nbsp;</h1>
