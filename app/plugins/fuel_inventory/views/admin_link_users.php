...
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div class="controls"><span><?php echo __('With selected','fuel_invetory') ?></span> 
        <select id="bulk-actions"> 
        <?php echo $form->options(array(__('Choose'), __('Link','fuel_invetory'), __('remove from Gas Station','fuel_invetory'))); ?>
        </select>
      ...
      <div id="users-table" class="panel panel-default">
        ...
        <div class="table-responsive">
          ...
          <thead>
            ...
            <th><?php echo __('Station','fuel_invetory') ?></th>
...
$('#all-users').append(loader);
  $.getJSON( Jsapi+'fuel-inventory/update-user-relation/', fdata , function( data ) {
      console.log(data);
    if(data.add == 'success'){
