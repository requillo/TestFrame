...
$template['name'] = 'Sol Theme';
$template['description'] = 'This was custom build for Sol and it is made with bootstrap 3';
...
$enqueue->app_style('assets/app/css/main.css?vers=3');
...
$enqueue->style('vendors/animate/animate.css');
