...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 21, 2017 at 10:21 PM
...
CREATE TABLE `rucom54_intake` (
  `id` int(14) NOT NULL,
  `intake_type` int(5) DEFAULT NULL,
...
--
-- Dumping data for table `rucom54_intake`
--

INSERT INTO `rucom54_intake` (`id`, `intake_type`, `intake_brand`, `intake_model`, `client_id`, `problem_text`, `work_solving`, `pub_date`, `user_id`, `status`) VALUES
(1, 1, 1, 'D5463', 1, 'Problemen met scherm en toetsenbord. Problemen met scherm en toetsenbord. Problemen met scherm en toetsenbord. Problemen met scherm en toetsenbord. Problemen met scherm en toetsenbord ', 'Scherm los maken en toetsenbord checken', '2017-09-21 09:30:34', 1, 1),
(2, 2, 0, 'Hp Flex 1254', 3, 'Reageerd niet. niets werk meer', 'Alles checken', '2017-09-21 09:31:41', 1, 1),
(3, 3, 1, 'Galaxy tap', 1, 'Gaat niet aan', 'Batterij, power', '2017-09-21 09:37:12', 1, 1),
(4, 4, 3, 'Galaxy s7 edge', 1, 'E-mail configuratie', '', '2017-09-21 09:38:58', 1, 1),
(5, 1, 4, 'Precision T7500', 3, 'Computer gaat niet aan toetsenbord werkt niet krijg zwart scherm bij Start Op', 'Check processor from the PC check ram complete diagnose van de laptop maken', '2017-09-21 17:04:46', 1, 1);
...
--
-- Dumping data for table `rucom54_intake_brands`
--

INSERT INTO `rucom54_intake_brands` (`id`, `product_brand`, `status`) VALUES
(1, 'Dell', 1),
(2, 'HP', 1),
(3, 'Samsung', 1),
(4, '', 1);
...
--
-- Dumping data for table `rucom54_intake_registered_clients`
--

INSERT INTO `rucom54_intake_registered_clients` (`id`, `f_name`, `l_name`, `address`, `telephone`, `email`, `pub_date`, `user_id`, `edit_date`, `user_id_edit`, `status`) VALUES
(1, 'Requillo', 'Kertoredjo', 'Fajalobilaan 13', '876229', 'requillo@live.com', '2017-09-21 09:30:34', 1, '2017-09-21 15:50:44', 1, 1),
(2, 'Joan', 'Hoop', 'Peterstraat 26', '534687', 'test@joan.com', '2017-09-21 09:31:41', 1, NULL, 0, 1),
(3, 'John', 'Doe', 'Tweekinderenweg 39', '985567', 'john@doe.com', '2017-09-21 09:37:11', 1, NULL, 0, 1),
(4, 'Requillo', 'Mothernature', 'Fajalobilaan 13', '8793226', '', '2017-09-21 17:04:46', 1, '2017-09-21 17:18:31', 1, 1);
...
--
-- Dumping data for table `rucom54_intake_types`
--

INSERT INTO `rucom54_intake_types` (`id`, `product_type`, `status`) VALUES
(1, 'Computer', 1),
(2, 'Laptop', 1),
(3, 'Tablet', 1),
(4, 'Telefoon', 1);
...
(7, 'intake_clients', '', '  intake_registered_clients,  intake,  intake_types,  intake_brands', 1, '1.2');
