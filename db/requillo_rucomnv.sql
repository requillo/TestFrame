...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 03, 2017 at 02:10 PM
...
INSERT INTO `rucom54_intake` (`id`, `intake_number`, `intake_type`, `intake_brand`, `intake_model`, `client_id`, `problem_text`, `work_solving`, `pub_date`, `user_id`, `status`) VALUES
(1, 0, 1, 1, 'Aspire 5349-2418', 1, 'Moederbord probleem', 'Moederbord online checken', '2017-10-02 14:39:12', 1, 1);
...
(1, 'Miguil', 'Molijn', 'Bramsstraat 23', '8610827 ', '', '2017-10-02 14:39:12', 1, NULL, 0, 1);
...
(1, 'intake_start_number', NULL, 1),
(2, 'print_header', NULL, 1),
(3, 'print_footer', NULL, 1);
...
(8, 'intake_clients', '', '  intake_registered_clients,  intake,  intake_types,  intake_brands,  intake_settings', 1, '1.2');
